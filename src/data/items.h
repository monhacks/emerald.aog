...
// Evolution Items
    ...
    {
        .name = _("Prism Scale"),
        .price = (I_PRICE >= GEN_9) ? 3500 : ((I_PRICE >= GEN_7) ? 2000 : 500),
        .description = COMPOUND_STRING(
            "A mysterious scale\n"
...
// Misc. Held Items
    ...
    {
        .name = _("King's Rock"),
        .price = (I_PRICE >= GEN_9) ? 5500 : ((I_PRICE >= GEN_7) ? 5000 : 100),
...
// Berries
    ...
    [ITEM_CHERI_BERRY] =
    {
        ...
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 300,
    ...
    [ITEM_ORAN_BERRY] =
    {
        ...
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 150,
        .holdEffect = HOLD_EFFECT_RESTORE_HP,
        .holdEffectParam = 10,
        .description = COMPOUND_STRING(
            "A hold item that\n"
    ...
    [ITEM_SITRUS_BERRY] =
    {
        ...
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 2000,
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM66] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SCALE_SHOT, // Todo
    },
    ...
    [ITEM_TM84] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SOLAR_BLADE, // Todo
    },
