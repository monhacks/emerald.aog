...
static const struct TrainerMon sParty_GruntWeatherInst1[] = {
    ...
    .moves = {MOVE_TAUNT, MOVE_CONFUSE_RAY, MOVE_ASSURANCE, MOVE_WING_ATTACK},
    },
    {
    .lvl = 35,
    .species = SPECIES_TENTACRUEL,
    .moves = {MOVE_ACID_ARMOR, MOVE_TOXIC, MOVE_HEX, MOVE_SURF},
    }
};
...
static const struct TrainerMon sParty_GruntWeatherInst2[] = {
    ...
    .species = SPECIES_GRIMER_ALOLAN,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_DISABLE, MOVE_KNOCK_OFF, MOVE_POISON_FANG, MOVE_TOXIC},
    },
    {
    .lvl = 35,
    .species = SPECIES_POLIWHIRL,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_HYPNOSIS, MOVE_AQUA_JET, MOVE_BODY_SLAM, MOVE_EARTH_POWER},
    }
};
...
static const struct TrainerMon sParty_GruntWeatherInst3[] = {
    ...
    .moves = {MOVE_POISON_FANG, MOVE_BITE, MOVE_SUPERSONIC, MOVE_WING_ATTACK},
    },
    {
    .lvl = 35,
    .species = SPECIES_LOMBRE,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_LEECH_SEED, MOVE_FAKE_OUT, MOVE_TEETER_DANCE, MOVE_KNOCK_OFF},
    },
    {
    .lvl = 35,
    .species = SPECIES_SEADRA,
    .moves = {MOVE_DRAGON_BREATH, MOVE_WATER_PULSE, MOVE_AGILITY, MOVE_SMOKESCREEN},
    }
};
...
static const struct TrainerMon sParty_GruntWeatherInst4[] = {
    ...
    .species = SPECIES_MAREANIE,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_VENOSHOCK, MOVE_SURF, MOVE_RECOVER},
    },
    {
    .lvl = 35,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_HAZE, MOVE_POISON_TAIL, MOVE_GLARE, MOVE_THIEF},
    },
};
...
static const struct TrainerMon sParty_ShellyWeatherInstitute[] = {
    ...
    .lvl = 37,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_FIRE_FANG, MOVE_ICE_FANG, MOVE_THUNDER_FANG, MOVE_CRUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 37,
    .species = SPECIES_SEADRA,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_SMOKESCREEN, MOVE_SURF, MOVE_HYPER_BEAM, MOVE_ICE_BEAM},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 37,
    ...
    .ability = ABILITY_VENOM_COATING,
    .moves = {MOVE_POISON_JAB, MOVE_GLARE, MOVE_SWAGGER, MOVE_FIRE_FANG},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 38,
    ...
    .moves = {MOVE_LIQUIDATION, MOVE_BANEFUL_BUNKER, MOVE_VENOSHOCK, MOVE_FIRE_FANG},
    }
...
static const struct TrainerMon sParty_Violet[] = {
    ...
    .moves = {MOVE_TOXIC, MOVE_VENOSHOCK, MOVE_GIGA_DRAIN}
    },
    {
    .lvl = 32,
    .species = SPECIES_GLOOM,
    .moves = {MOVE_MOONBLAST, MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN},
    },
    {
    .lvl = 32,
    .species = SPECIES_SUNFLORA,
    .moves = {MOVE_NATURE_POWER, MOVE_ECHOED_VOICE, MOVE_GIGA_DRAIN},
    }
};
...
static const struct TrainerMon sParty_Stark[] = {
    ...
    .moves = {MOVE_DRAGON_TAIL, MOVE_STEALTH_ROCK, MOVE_THUNDER_FANG, MOVE_ROCK_SLIDE},
    }
};
...
static const struct TrainerMon sParty_Dusty1[] = {
    ...
    .moves = {MOVE_DIG, MOVE_FIRE_FANG, MOVE_RAPID_SPIN, MOVE_KNOCK_OFF},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 26,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_FURY_CUTTER, MOVE_AERIAL_ACE},
...
static const struct TrainerMon sParty_Foster[] = {
    ...
    .lvl = 30,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_SAND_ATTACK, MOVE_CRUSH_CLAW},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 30,
    ...
    .moves = {MOVE_DIG, MOVE_STOMPING_TANTRUM, MOVE_FLING, MOVE_HEADBUTT},
    }
};
...
static const struct TrainerMon sParty_Anelace[] = {
    {
    ...
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_ICY_WIND, MOVE_CONFUSE_RAY, MOVE_AURORA_VEIL},
    },
    {
    .iv = TRAINER_PARTY_IVS(10, 10, 10, 10, 10, 10),
    .lvl = 30,
    ...
    .moves = {MOVE_RAPID_SPIN, MOVE_ICICLE_SPEAR, MOVE_IRON_HEAD, MOVE_AERIAL_ACE},
    },
    {
    .iv = TRAINER_PARTY_IVS(10, 10, 10, 10, 10, 10),
    .lvl = 30,
    ...
    .heldItem = ITEM_ICY_ROCK,
    .moves = {MOVE_SNOWSCAPE, MOVE_HYPER_BEAM, MOVE_ICY_WIND, MOVE_HEX},
    },
    {
    .iv = TRAINER_PARTY_IVS(10, 10, 10, 10, 10, 10),
    .lvl = 30,
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_POISON_JAB, MOVE_TRIPLE_AXEL, MOVE_BRICK_BREAK},
    }
...
static const struct TrainerMon sParty_GabbyAndTy2[] = {
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_FLASH_CANNON, MOVE_REFLECT},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    ...
    .moves = {MOVE_ROUND, MOVE_BULLDOZE, MOVE_BITE, MOVE_DISARMING_VOICE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    .species = SPECIES_CASTFORM,
    .moves = {MOVE_RAIN_DANCE, MOVE_WEATHER_BALL, MOVE_THUNDER, MOVE_HEADBUTT},
    }
...
static const struct TrainerMon sParty_GabbyAndTy3[] = {
    ...
    .ability = ABILITY_PUNK_ROCK,
    .moves = {MOVE_HYPER_VOICE, MOVE_BULLDOZE, MOVE_FLAMETHROWER, MOVE_DISARMING_VOICE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 38,
    .species = SPECIES_CASTFORM,
    .moves = {MOVE_RAIN_DANCE, MOVE_WEATHER_BALL, MOVE_THUNDER, MOVE_BLIZZARD},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 38,
    .species = SPECIES_MACHOKE,
    .moves = {MOVE_KNOCK_OFF, MOVE_SUBMISSION, MOVE_STRENGTH, MOVE_BULK_UP},
    }
};
...
static const struct TrainerMon sParty_Gwen[] = {
    ...
    .moves = {MOVE_PSYCHIC, MOVE_NUZZLE, MOVE_ELECTRO_BALL, MOVE_AGILITY},
    }
};
...
static const struct TrainerMon sParty_Simon[] = {
    ...
    .lvl = 15,
    .species = SPECIES_MARILL,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_BUBBLE_BEAM, MOVE_BOUNCE},
    }
};
...
static const struct TrainerMon sParty_Randall[] = {
    ...
    .moves = {MOVE_EXTREME_SPEED, MOVE_SHADOW_CLAW, MOVE_REST, MOVE_PROTECT},
    ...
    .moves = {MOVE_FACADE, MOVE_AGILITY, MOVE_BRAVE_BIRD, MOVE_STEEL_WING},
    }
};
...
static const struct TrainerMon sParty_Parker[] = {
    ...
    .moves = {MOVE_TEETER_DANCE, MOVE_DIZZY_PUNCH, MOVE_BODY_SLAM, MOVE_SUCKER_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 0),
    .lvl = 32,
    ...
    .moves = {MOVE_TRICK_ROOM, MOVE_INSTRUCT, MOVE_CALM_MIND, MOVE_STORED_POWER},
    }
};
...
static const struct TrainerMon sParty_George[] = {
    ...
    .moves = {MOVE_SLACK_OFF, MOVE_COUNTER, MOVE_THROAT_CHOP, MOVE_YAWN},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .moves = {MOVE_ROOST, MOVE_BEAK_BLAST, MOVE_ROCK_BLAST, MOVE_FURY_ATTACK},
    }
};
...
static const struct TrainerMon sParty_Berke[] = {
    ...
    .moves = {MOVE_SLASH, MOVE_THROAT_CHOP, MOVE_NONE, MOVE_NONE},
    ...
    .moves = {MOVE_HELPING_HAND, MOVE_FAKE_OUT, MOVE_TICKLE, MOVE_HEAL_BELL},
    }
};
...
static const struct TrainerMon sParty_Mary[] = {
    ...
    .lvl = 32,
    .species = SPECIES_ZANGOOSE,
    .moves = {MOVE_HONE_CLAWS, MOVE_AERIAL_ACE, MOVE_CRUSH_CLAW, MOVE_POWER_TRIP},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    .species = SPECIES_DELCATTY,
    .moves = {MOVE_FAKE_OUT, MOVE_SHOCK_WAVE, MOVE_DISARMING_VOICE, MOVE_RETURN},
    .friendship = 255,
    }
};
...
static const struct TrainerMon sParty_Alexia[] = {
    ...
    .moves = {MOVE_DEFENSE_CURL, MOVE_BODY_SLAM, MOVE_HEAVY_SLAM, MOVE_CRUNCH},
...
static const struct TrainerMon sParty_Jody[] = {
    ...
    .lvl = 32,
    .species = SPECIES_ZANGOOSE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_NIGHT_SLASH, MOVE_PROTECT},
    .heldItem = ITEM_TOXIC_ORB,
    ...
    .moves = {MOVE_FIRE_FANG, MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_THUNDER_FANG},
    }
};
...
static const struct TrainerMon sParty_Brooke1[] = {
    ...
    .moves = {MOVE_THUNDER_FANG, MOVE_INCINERATE, MOVE_BITE, MOVE_NASTY_PLOT},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 24,
    .species = SPECIES_ROSERADE,
    .moves = {MOVE_LEECH_SEED, MOVE_SLUDGE, MOVE_GIGA_DRAIN},
    }
};
...
static const struct TrainerMon sParty_Cindy2[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_COVET, MOVE_TAIL_WHIP, MOVE_REST, MOVE_BABY_DOLL_EYES},
    },
    {
    .lvl = 33,
    .species = SPECIES_AZUMARILL,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_PLAY_ROUGH, MOVE_TAIL_WHIP, MOVE_AQUA_RING, MOVE_CHARM},
    }
};
...
static const struct TrainerMon sParty_Sheila[] = {
    ...
    .moves = {MOVE_CHARM, MOVE_GIGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_LEECH_SEED},
    },
    {
    .lvl = 27,
...
static const struct TrainerMon sParty_Winston2[] = {
    ...
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_NIGHT_SLASH, MOVE_TAIL_WHIP, MOVE_REST, MOVE_HEADBUTT},
    },
    {
    .lvl = 33,
    .species = SPECIES_GUMSHOOS,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_TAKE_DOWN, MOVE_WORK_UP, MOVE_BITE, MOVE_SAND_ATTACK},
    }
};
...
static const struct TrainerMon sParty_Steve1[] = {
    ...
    .moves = {MOVE_PROTECT, MOVE_ROCK_SLIDE, MOVE_HEADBUTT, MOVE_ROAR},
    },
    {
    .lvl = 25,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_BITE, MOVE_POISON_FANG, MOVE_GLARE, MOVE_SCREECH},
    }
};
...
static const struct TrainerMon sParty_GruntMtChimney1[] = {
    ...
    .lvl = 25,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_INCINERATE, MOVE_BULLDOZE, MOVE_GROWL, MOVE_AMNESIA},
    },
    {
    .lvl = 25,
    .species = SPECIES_CACNEA,
    .moves = {MOVE_BULLET_SEED, MOVE_BULLDOZE, MOVE_GROWL, MOVE_AMNESIA},
    }
};
...
static const struct TrainerMon sParty_Koichi[] = {
    ...
    .lvl = 30,
    .species = SPECIES_MACHOKE,
    .moves = {MOVE_KNOCK_OFF, MOVE_REVENGE, MOVE_BULK_UP, MOVE_FIRE_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 30,
    ...
    .moves = {MOVE_AQUA_JET, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH, MOVE_HYPNOSIS},
    }
};
...
static const struct TrainerMon sParty_Nob1[] = {
    ...
    .lvl = 25,
    .species = SPECIES_POLIWHIRL,
    .moves = {MOVE_ICE_PUNCH, MOVE_HYPNOSIS, MOVE_MUD_SHOT, MOVE_BUBBLE_BEAM},
    }
};
...
static const struct TrainerMon sParty_Yuji[] = {
    ...
    .moves = {MOVE_TAUNT, MOVE_OCTOLOCK, MOVE_BULK_UP, MOVE_AQUA_JET},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    .species = SPECIES_MACHOKE,
    .moves = {MOVE_STRENGTH, MOVE_KNOCK_OFF, MOVE_LEER, MOVE_ROCK_SLIDE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_PAYBACK, MOVE_BELLY_DRUM, MOVE_DRAIN_PUNCH, MOVE_FAKE_OUT},
    }
};
...
static const struct TrainerMon sParty_Kirk[] = {
    ...
    .moves = {MOVE_CHARGE_BEAM, MOVE_THUNDER_WAVE, MOVE_STRUGGLE_BUG, MOVE_TAIL_GLOW},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 22,
    .species = SPECIES_ORICORIO_POM_POM,
    .moves = {MOVE_PECK, MOVE_FEATHER_DANCE, MOVE_HELPING_HAND, MOVE_SHOCK_WAVE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 22,
    .species = SPECIES_LOUDRED,
    .moves = {MOVE_HOWL, MOVE_BITE, MOVE_ECHOED_VOICE, MOVE_SHOCK_WAVE},
    }
};
...
static const struct TrainerMon sParty_Shawn[] = {
    ...
    .moves = {MOVE_SWIFT, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_ICE_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 24,
    .species = SPECIES_EELEKTRIK,
    .moves = {MOVE_ACID, MOVE_THUNDER_WAVE, MOVE_CHARGE_BEAM, MOVE_CRUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 24,
...
static const struct TrainerMon sParty_Cole[] = {
    ...
    .moves = {MOVE_FIRE_PUNCH, MOVE_SHADOW_BONE, MOVE_RETALIATE, MOVE_BRICK_BREAK},
    }
};
...
static const struct TrainerMon sParty_Jeff[] = {
    ...
    .moves = {MOVE_OVERHEAT, MOVE_ANCIENT_POWER, MOVE_CLEAR_SMOG, MOVE_CURSE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 27,
    .species = SPECIES_MAGMAR,
    .moves = {MOVE_FLAMETHROWER, MOVE_CONFUSE_RAY, MOVE_THUNDER_PUNCH, MOVE_CLEAR_SMOG},
    }
};
...
static const struct TrainerMon sParty_Axle[] = {
    ...
    .moves = {MOVE_SLUDGE, MOVE_FLAMETHROWER, MOVE_TOXIC, MOVE_ASSURANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 28,
    .species = SPECIES_SALANDIT,
    .moves = {MOVE_INCINERATE, MOVE_NASTY_PLOT, MOVE_TOXIC, MOVE_VENOSHOCK},
    }
};
...
static const struct TrainerMon sParty_Jace[] = {
    ...
    .moves = {MOVE_FLAME_CHARGE, MOVE_ACROBATICS, MOVE_QUICK_ATTACK, MOVE_GROWL},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 27,
    .species = SPECIES_HOUNDOOM,
    .moves = {MOVE_OVERHEAT, MOVE_THUNDER_FANG, MOVE_HOWL, MOVE_BITE},
    },
};
...
static const struct TrainerMon sParty_Keegan[] = {
    ...
    .moves = {MOVE_DRAGON_TAIL, MOVE_OVERHEAT, MOVE_IRON_DEFENSE, MOVE_PROTECT},
    .heldItem = ITEM_LEFTOVERS,
    }
};
...
static const struct TrainerMon sParty_Bernie1[] = {
    ...
    .lvl = 24,
    .species = SPECIES_SLUGMA,
    .moves = {MOVE_EMBER, MOVE_ANCIENT_POWER, MOVE_CLEAR_SMOG, MOVE_YAWN},
    },
    {
    .lvl = 24,
    .species = SPECIES_FLETCHINDER,
    .moves = {MOVE_FLAME_CHARGE, MOVE_ACROBATICS, MOVE_AGILITY, MOVE_ROOST},
    }
};
...
static const struct TrainerMon sParty_Drew[] = {
    ...
    .moves = {MOVE_DIG, MOVE_CRUSH_CLAW, MOVE_METAL_CLAW, MOVE_HONE_CLAWS},
    },
    {
    .lvl = 25,
    .species = SPECIES_SANDILE,
    .moves = {MOVE_DIG, MOVE_BITE, MOVE_SWAGGER, MOVE_SAND_ATTACK},
    }
};
...
static const struct TrainerMon sParty_Beau[] = {
    ...
    .lvl = 25,
    .species = SPECIES_BALTOY,
    .moves = {MOVE_RAPID_SPIN, MOVE_MUD_SLAP, MOVE_PSYBEAM, MOVE_COSMIC_POWER},
    },
    {
    .lvl = 25,
    .species = SPECIES_SANDSHREW,
    .moves = {MOVE_FURY_CUTTER, MOVE_SAND_ATTACK, MOVE_RAPID_SPIN, MOVE_BULLDOZE},
    },
    {
    .lvl = 25,
...
static const struct TrainerMon sParty_Shane[] = {
    ...
    .moves = {MOVE_RAPID_SPIN, MOVE_METAL_CLAW, MOVE_POWDER_SNOW, MOVE_ROLLOUT},
    },
    {
    .lvl = 23,
    .species = SPECIES_NUZLEAF,
    .moves = {MOVE_FAKE_OUT, MOVE_PAYBACK, MOVE_RAZOR_LEAF, MOVE_SWAGGER},
    }
};
...
static const struct TrainerMon sParty_Justin[] = {
    ...
    .lvl = 27,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_ANCIENT_POWER, MOVE_SLASH, MOVE_SHADOW_SNEAK, MOVE_SHOCK_WAVE},
    },
    {
    .lvl = 27,
    .species = SPECIES_CHARJABUG,
    .moves = {MOVE_SPARK, MOVE_BUG_BITE, MOVE_LIGHT_SCREEN, MOVE_PROTECT},
    },
    {
    .lvl = 27,
    .species = SPECIES_CROAGUNK,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_POISON_JAB, MOVE_LOW_KICK, MOVE_TAUNT},
    }
};
...
static const struct TrainerMon sParty_Brent[] = {
    ...
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_X_SCISSOR, MOVE_FOCUS_ENERGY, MOVE_NIGHT_SLASH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    ...
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_BULLET_PUNCH, MOVE_X_SCISSOR, MOVE_AGILITY, MOVE_COUNTER},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    ...
    .ability = ABILITY_SHARPNESS,
    .moves = {MOVE_STONE_AXE, MOVE_FURY_CUTTER, MOVE_SLASH, MOVE_NIGHT_SLASH},
    }
};
...
static const struct TrainerMon sParty_Donald[] = {
    ...
    .moves = {MOVE_POISON_TAIL, MOVE_SCREECH, MOVE_BUG_BITE, MOVE_TOXIC},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    .species = SPECIES_WHIRLIPEDE,
    .moves = {MOVE_IRON_DEFENSE, MOVE_TOXIC, MOVE_VENOSHOCK, MOVE_PROTECT},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    ...
    .ability = ABILITY_SPEED_BOOST,
    .moves = {MOVE_PROTECT, MOVE_POISON_JAB, MOVE_X_SCISSOR, MOVE_BULLDOZE},
    .isShiny = TRUE,
    }
};
...
static const struct TrainerMon sParty_Taylor[] = {
    ...
    .lvl = 32,
    .species = SPECIES_ARAQUANID,
    .moves = {MOVE_CRUNCH, MOVE_AQUA_RING, MOVE_BUBBLEBEAM, MOVE_BUG_BITE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    .species = SPECIES_MASQUERAIN,
    .moves = {MOVE_STUN_SPORE, MOVE_AIR_SLASH, MOVE_WHIRLWIND, MOVE_HYDRO_PUMP},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 33,
    ...
    .ability = ABILITY_SPEED_BOOST,
    .moves = {MOVE_ANCIENT_POWER, MOVE_AIR_SLASH, MOVE_UPROAR, MOVE_DETECT},
    .isShiny = TRUE,
    }
};
...
static const struct TrainerMon sParty_Edward[] = {
    ...
    .lvl = 20,
    .species = SPECIES_BRONZOR,
    .moves = {MOVE_CONFUSION, MOVE_GYRO_BALL, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY},
    },
    {
    .lvl = 20,
    .species = SPECIES_KADABRA,
    .moves = {MOVE_HIDDEN_POWER, MOVE_REFLECT, MOVE_CONFUSION, MOVE_DISABLE},
    }
};
...
static const struct TrainerMon sParty_Jaclyn[] = {
    ...
    .moves = {MOVE_YAWN, MOVE_CONFUSION, MOVE_CALM_MIND, MOVE_STORED_POWER},
    },
    {
    .lvl = 20,
    .species = SPECIES_KADABRA,
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_BLOCK, MOVE_THUNDER_WAVE, MOVE_TACKLE, MOVE_ROCK_TOMB},
    .isShiny = TRUE,
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_SABLEYE,
    .moves = {MOVE_REFLECT, MOVE_FAKE_OUT, MOVE_CURSE, MOVE_ASTONISH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 17,
    ...
    .lvl = 18,
    .species = SPECIES_VULPIX,
    .moves = {MOVE_EMBER, MOVE_HEX, MOVE_CONFUSE_RAY, MOVE_WILL_O_WISP},
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 20,
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .moves = {MOVE_ROLLOUT, MOVE_SCREECH, MOVE_SELF_DESTRUCT, MOVE_SHOCK_WAVE},
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 25,
    .species = SPECIES_VOLBEAT,
    .moves = {MOVE_TAIL_GLOW, MOVE_STRUGGLE_BUG, MOVE_CONFUSE_RAY, MOVE_SHOCK_WAVE},
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 25,
    .species = SPECIES_EELEKTRIK,
    .moves = {MOVE_SHOCK_WAVE, MOVE_CRUNCH, MOVE_GIGA_DRAIN, MOVE_HEADBUTT},
    },
    {
    ...
    .moves = {MOVE_MUD_SHOT, MOVE_SHOCK_WAVE, MOVE_TACKLE, MOVE_WATER_GUN},
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 27,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICE_FANG, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_BITE},
    .isShiny = TRUE,
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .species = SPECIES_CAMERUPT,
    .gender = TRAINER_MON_FEMALE,
    .moves = {MOVE_OVERHEAT, MOVE_TRAILBLAZE, MOVE_BULLDOZE, MOVE_ATTRACT},
    ...
    .moves = {MOVE_OVERHEAT, MOVE_SHELL_SMASH, MOVE_EARTH_POWER, MOVE_ATTRACT},
    .isShiny = TRUE,
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .species = SPECIES_SPINDA,
    .heldItem = ITEM_LEFTOVERS, 
    .moves = {MOVE_SKILL_SWAP, MOVE_DIZZY_PUNCH, MOVE_HAMMER_ARM, MOVE_ENCORE},
    ...
    .moves = {MOVE_SNARL, MOVE_SHADOW_BALL, MOVE_FACADE, MOVE_U_TURN},
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 34,
    .species = SPECIES_EXPLOUD,
    .moves = {MOVE_HYPER_VOICE, MOVE_FLAMETHROWER, MOVE_THUNDERBOLT, MOVE_CRUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 34,
    .species = SPECIES_SUNFLORA,
    .moves = {MOVE_NATURE_POWER, MOVE_SOLAR_BEAM, MOVE_EARTH_POWER, MOVE_FACADE},
    ...
    .moves = {MOVE_TRICK_ROOM, MOVE_PSYCHIC, MOVE_FACADE, MOVE_LIGHT_SCREEN},
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 36,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_YAWN, MOVE_FACADE, MOVE_THROAT_CHOP},
    .isShiny = TRUE,
    }
};
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_ROOST, MOVE_STEALTH_ROCK, MOVE_TOXIC, MOVE_IRON_HEAD},
    },
    {
    ...
    .moves = {MOVE_U_TURN, MOVE_FACADE, MOVE_REVERSAL, MOVE_ROOST},
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 43,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_BODY_SLAM, MOVE_AIR_SLASH, MOVE_GIGA_DRAIN, MOVE_BULLDOZE},
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 43,
    ...
    .moves = {MOVE_ROOST, MOVE_VOLT_SWITCH, MOVE_THUNDER_WAVE, MOVE_AIR_SLASH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 44,
    ...
    .moves = {MOVE_FLARE_BLITZ, MOVE_BRAVE_BIRD, MOVE_ROOST, MOVE_U_TURN},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 45,
    ...
    .moves = {MOVE_EARTH_POWER, MOVE_DRAGON_PULSE, MOVE_HURRICANE, MOVE_MOONBLAST},
    .isShiny = TRUE,
    }
};
...
static const struct TrainerMon sParty_Ted[] = {
    ...
    .lvl = 24,
    .species = SPECIES_KIRLIA,
    .moves = {MOVE_FLASH, MOVE_PSYBEAM, MOVE_CALM_MIND, MOVE_DRAINING_KISS},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 24,
    .species = SPECIES_SUDOWOODO,
    .moves = {MOVE_SLAM, MOVE_ROCK_TOMB, MOVE_PROTECT, MOVE_NONE},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 24,
    .species = SPECIES_VOLBEAT,
    .moves = {MOVE_THUNDER_WAVE, MOVE_CHARGE_BEAM, MOVE_PROTECT, MOVE_CONFUSE_RAY},
    }
};
...
static const struct TrainerMon sParty_Jerry2[] = {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_PSYCHIC, MOVE_AERIAL_ACE},
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 33,
    .species = SPECIES_SNORUNT, 
    .gender = TRAINER_MON_FEMALE,
    .moves = {MOVE_ICE_SHARD, MOVE_FROST_BREATH, MOVE_BITE, MOVE_PROTECT},
    }
};
...
static const struct TrainerMon sParty_Jerry3[] = {
    ...
    .lvl = 41,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH, MOVE_PSYCHIC, MOVE_AERIAL_ACE},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),    
    .lvl = 41,
    .species = SPECIES_FROSLASS,
    .gender = TRAINER_MON_FEMALE,
    .moves = {MOVE_DRAINING_KISS, MOVE_FROST_BREATH, MOVE_CONFUSE_RAY, MOVE_DOUBLE_TEAM},
    }
};
...
static const struct TrainerMon sParty_Jerry4[] = {
    ...
    .lvl = 44,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH, MOVE_PSYCHO_CUT, MOVE_AQUA_CUTTER},
    },
    {
    .iv = TRAINER_PARTY_IVS(4, 4, 4, 4, 4, 4),
    .lvl = 44,
    .species = SPECIES_FROSLASS,
    .gender = TRAINER_MON_FEMALE,
    .moves = {MOVE_HEX, MOVE_FROST_BREATH, MOVE_CONFUSE_RAY, MOVE_WILL_O_WISP},
    }
};
...
static const struct TrainerMon sParty_Jerry5[] = {
    ...
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH, MOVE_PSYCHO_CUT, MOVE_SACRED_SWORD},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 50,
    ...
    .ability = ABILITY_CONTRARY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_BODY_SLAM, MOVE_DIZZY_PUNCH, MOVE_HYPNOSIS},
    }
};
...
static const struct TrainerMon sParty_Karen1[] = {
    ...
    .moves = {MOVE_ASTONISH, MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_RECYCLE},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 9,
...
static const struct TrainerMon sParty_Georgia[] = {
    ...
    .moves = {MOVE_MACH_PUNCH, MOVE_HEADBUTT, MOVE_MEGA_DRAIN, MOVE_LEECH_SEED},
    .ability = ABILITY_TECHNICIAN,
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
...
static const struct TrainerMon sParty_Karen2[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SYRUP_BOMB, MOVE_DRAGON_BREATH, MOVE_RECYCLE, MOVE_INFESTATION},
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 33,
    .species = SPECIES_DELCATTY,
    .moves = {MOVE_FAKE_OUT, MOVE_ATTRACT, MOVE_TICKLE, MOVE_FACADE},
    }
};
...
static const struct TrainerMon sParty_Karen3[] = {
    ...
    .species = SPECIES_DIPPLIN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SYRUP_BOMB, MOVE_DRAGON_PULSE, MOVE_RECOVER, MOVE_INFESTATION},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 39,
    .species = SPECIES_DELCATTY,
    .moves = {MOVE_COSMIC_POWER, MOVE_ATTRACT, MOVE_TICKLE, MOVE_FACADE},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 39,
    .species = SPECIES_LOUDRED,
    .moves = {MOVE_BITE, MOVE_UPROAR, MOVE_CIRCLE_THROW, MOVE_SHOCK_WAVE},
    }
};
...
static const struct TrainerMon sParty_Karen4[] = {
    ...
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SHADOW_BALL, MOVE_HYPER_VOICE, MOVE_HAMMER_ARM, MOVE_THUNDERBOLT},
    }
};
...
static const struct TrainerMon sParty_Karen5[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SYRUP_BOMB, MOVE_DRAGON_PULSE, MOVE_RECOVER, MOVE_ICE_BEAM},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 48,
    .species = SPECIES_DELCATTY,
    .friendship = 255,
    .moves = {MOVE_COSMIC_POWER, MOVE_ATTRACT, MOVE_TICKLE, MOVE_RETURN},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 48,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SHADOW_BALL, MOVE_BOOMBURST, MOVE_FOCUS_BLAST, MOVE_THUNDERBOLT},
    }
};
...
static const struct TrainerMon sParty_AnnaAndMeg1[] = {
    ...
    .lvl = 20,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_SLASH, MOVE_GROWL, MOVE_HEADBUTT, MOVE_SURF},
    },
    {
    .lvl = 20,
    .species = SPECIES_MAKUHITA,
    .moves = {MOVE_WHIRLWIND, MOVE_KNOCK_OFF, MOVE_ARM_THRUST, MOVE_BULK_UP},
    },
    {
    .lvl = 20,
    .species = SPECIES_LINOONE_GALARIAN,
    .moves = {MOVE_SNARL, MOVE_NIGHT_SLASH, MOVE_HEADBUTT, MOVE_GROWL},
    },
    {
    .lvl = 20,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_FORCE_PALM, MOVE_PSYBEAM, MOVE_DETECT, MOVE_WORK_UP},
    },
};
...
static const struct TrainerMon sParty_Miguel1[] = {
    ...
    .lvl = 20,
    .species = SPECIES_LEDIAN,
    .moves = {MOVE_AERIAL_ACE, MOVE_BULLET_PUNCH, MOVE_MACH_PUNCH, MOVE_REFLECT},
    },
    {
    .lvl = 20,
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_COSMIC_POWER, MOVE_ATTRACT, MOVE_FURY_SWIPES, MOVE_DISARMING_VOICE},
    }
};
...
static const struct TrainerMon sParty_Victoria[] = {
    ...
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_COSMIC_POWER, MOVE_DISARMING_VOICE, MOVE_ATTRACT, MOVE_CHARM}
    }
};
...
static const struct TrainerMon sParty_Timothy1[] = {
    ...
    .lvl = 30,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_FAKE_OUT, MOVE_BULK_UP, MOVE_KNOCK_OFF, MOVE_DRAIN_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 30,
    .species = SPECIES_GRAPPLOCT,
    .moves = {MOVE_OCTOLOCK, MOVE_AQUA_JET, MOVE_BULK_UP, MOVE_ICE_PUNCH},
    }
};
...
static const struct TrainerMon sParty_Vicky[] = {
    ...
    .lvl = 21,
    .species = SPECIES_ZANGOOSE,
    .moves = {MOVE_SLASH, MOVE_NIGHT_SLASH, MOVE_COUNTER, MOVE_QUICK_ATTACK},
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 21,
...
static const struct TrainerMon sParty_Josh[] = {
    ...
    .ability = ABILITY_STURDY,
    .moves = {MOVE_TACKLE, MOVE_ROLLOUT, MOVE_DEFENSE_CURL, MOVE_NONE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 12,
...
static const struct TrainerMon sParty_Ben[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLUDGE, MOVE_YAWN, MOVE_THUNDER_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 23,
    .species = SPECIES_LINOONE_GALARIAN,
    .moves = {MOVE_HEADBUTT, MOVE_SAND_ATTACK, MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 23,
    .species = SPECIES_RAICHU_ALOLAN,
    .moves = {MOVE_PSYCHIC, MOVE_ELECTRO_BALL, MOVE_THUNDER_WAVE, MOVE_SWEET_KISS},
    }
};
...
static const struct TrainerMon sParty_Jaylen[] = {
    ...
    .lvl = 23,
    .species = SPECIES_TRAPINCH,
    .moves = {MOVE_BULLDOZE, MOVE_BITE, MOVE_SAND_ATTACK, MOVE_NONE},
    },
    {
    .lvl = 23,
    .species = SPECIES_MURKROW,
    .moves = {MOVE_WING_ATTACK, MOVE_SNARL, MOVE_THUNDER_WAVE, MOVE_TAUNT},
    .ability = ABILITY_PRANKSTER,
    },
    {
    .lvl = 23,
    .species = SPECIES_DRILBUR,
    .moves = {MOVE_BULLDOZE, MOVE_METAL_CLAW, MOVE_RAPID_SPIN, MOVE_HONE_CLAWS},
    }
};
...
static const struct TrainerMon sParty_Calvin2[] = {
    ...
    .lvl = 35,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_SNARL, MOVE_JAW_LOCK, MOVE_FIRE_FANG, MOVE_HOWL},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 35,
    ...
    .moves = {MOVE_BEAK_BLAST, MOVE_BULLET_SEED, MOVE_PROTECT, MOVE_FURY_ATTACK},
    }
};
...
static const struct TrainerMon sParty_Calvin3[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_SNARL, MOVE_JAW_LOCK, MOVE_FIRE_FANG, MOVE_THUNDER_FANG},
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 40,
    ...
    .ability = ABILITY_SKILL_LINK,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BEAK_BLAST, MOVE_BULLET_SEED, MOVE_PROTECT, MOVE_ROCK_BLAST},
    }
};
...
static const struct TrainerMon sParty_Calvin4[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_POISON_FANG, MOVE_FIRE_FANG},
    },
};
...
static const struct TrainerMon sParty_Calvin5[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_POISON_FANG, MOVE_JAW_LOCK, MOVE_FIRE_FANG, MOVE_THUNDER_FANG},
    },
    {
    .iv = TRAINER_PARTY_IVS(4, 4, 4, 4, 4, 4),
    .lvl = 50,
...
static const struct TrainerMon sParty_Claude[] = {
    ...
    .moves = {MOVE_BULLDOZE, MOVE_WATER_PULSE, MOVE_SNORE, MOVE_REST},
    }
};
...
static const struct TrainerMon sParty_Nolan[] = {
    ...
    .moves = {MOVE_PAYBACK, MOVE_BRINE, MOVE_MINIMIZE, MOVE_POISON_STING},
    }
};
...
static const struct TrainerMon sParty_Barny[] = {
    ...
    .ability = ABILITY_HEAVY_BALLISTICS,
    .moves = {MOVE_OCTAZOOKA, MOVE_AURORA_BEAM, MOVE_BULLET_SEED, MOVE_LOCK_ON},
    },
    {
    .lvl = 32,
    .species = SPECIES_SHARPEDO,
    .ability = ABILITY_ROUGH_SKIN,
    .moves = {MOVE_SWAGGER, MOVE_NIGHT_SLASH, MOVE_AQUA_JET, MOVE_ICE_FANG},
    },
};
...
static const struct TrainerMon sParty_Carter[] = {
    ...
    .lvl = 30,
    .species = SPECIES_GYARADOS,
    .moves = {MOVE_WATERFALL, MOVE_CRUNCH, MOVE_SCARY_FACE, MOVE_ICE_FANG},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 30,
    .species = SPECIES_MILOTIC,
    .moves = {MOVE_LIFE_DEW, MOVE_WATER_PULSE, MOVE_ATTRACT, MOVE_AQUA_RING},
    }
};
...
static const struct TrainerMon sParty_Elliot2[] = {
    ...
    .lvl = 36,
    .species = SPECIES_GYARADOS,
    .moves = {MOVE_AQUA_TAIL, MOVE_CRUNCH, MOVE_DRAGON_DANCE, MOVE_RAIN_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 36,
    .species = SPECIES_SKRELP,
    .moves = {MOVE_TOXIC, MOVE_SURF, MOVE_SLUDGE_BOMB, MOVE_SMOKESCREEN},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 36,
    .species = SPECIES_CLAUNCHER,
    .moves = {MOVE_WATER_PULSE, MOVE_AQUA_JET, MOVE_FLASH_CANNON, MOVE_ICY_WIND},
    }
};
...
static const struct TrainerMon sParty_Elliot3[] = {
    ...
    .lvl = 43,
    .species = SPECIES_WAILORD,
    .moves = {MOVE_BOUNCE, MOVE_HEAVY_SLAM, MOVE_SURF, MOVE_ICY_WIND},
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 42,
    .species = SPECIES_DRAGALGE,
    .moves = {MOVE_TOXIC, MOVE_DRAGON_PULSE, MOVE_SLUDGE_BOMB, MOVE_THUNDERBOLT},
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 42,
    .species = SPECIES_CLAWITZER,
    .moves = {MOVE_WATER_PULSE, MOVE_AURA_SPHERE, MOVE_FLASH_CANNON, MOVE_ICY_WIND},
    }
};
...
static const struct TrainerMon sParty_Elliot4[] = {
    ...
    .lvl = 48,
    .species = SPECIES_GYARADOS,
    .moves = {MOVE_AQUA_TAIL, MOVE_HURRICANE, MOVE_DRAGON_DANCE, MOVE_RAIN_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 48,
    .species = SPECIES_WAILORD,
    .moves = {MOVE_BODY_SLAM, MOVE_HEAVY_SLAM, MOVE_SURF, MOVE_REST},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 48,
...
static const struct TrainerMon sParty_Elliot5[] = {
    ...
    .lvl = 53,
    .species = SPECIES_GYARADOS,
    .moves = {MOVE_WATERFALL, MOVE_THUNDER_FANG, MOVE_DRAGON_DANCE, MOVE_RAIN_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(4, 4, 4, 4, 4, 4),
    .lvl = 54,
    .species = SPECIES_WAILORD,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SLEEP_TALK, MOVE_HEAVY_SLAM, MOVE_WATER_SPOUT, MOVE_REST},
    },
    {
    .iv = TRAINER_PARTY_IVS(4, 4, 4, 4, 4, 4),
    .lvl = 53,
    ...
    .species = SPECIES_CLAWITZER,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_WATER_PULSE, MOVE_AURA_SPHERE, MOVE_FLASH_CANNON, MOVE_DARK_PULSE},
    }
};
...
static const struct TrainerMon sParty_Benjamin1[] = {
    ...
    .lvl = 23,
    .species = SPECIES_CHARJABUG,
    .moves = {MOVE_CHARGE, MOVE_SPARK, MOVE_BUG_BITE, MOVE_BITE},
    }
};
...
static const struct TrainerMon sParty_Abigail1[] = {
    ...
    .lvl = 20,
    .species = SPECIES_CHARJABUG,
    .moves = {MOVE_CHARGE, MOVE_FLASH, MOVE_BUG_BITE, MOVE_BITE},
    }
};
...
static const struct TrainerMon sParty_Perry[] = {
    ...
    .moves = {MOVE_TAILWIND, MOVE_WATER_PULSE, MOVE_PROTECT, MOVE_HURRICANE},
    },
    {
    .lvl = 32,
    .species = SPECIES_KILOWATTREL,
    .moves = {MOVE_AIR_SLASH, MOVE_ELECTRO_BALL, MOVE_THUNDER_WAVE, MOVE_UPROAR},
    },
};
...
static const struct TrainerMon sParty_Hugh[] = {
    ...
    .lvl = 34,
    .species = SPECIES_ORICORIO_POM_POM,
    .moves = {MOVE_FEATHER_DANCE, MOVE_THUNDER_WAVE, MOVE_CONFUSE_RAY, MOVE_REVELATION_DANCE},
    },
    {
    .lvl = 34,
    .species = SPECIES_TROPIUS,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_STOMP, MOVE_SEED_BOMB, MOVE_LEECH_SEED, MOVE_WHIRLWIND},
    }
};
...
static const struct TrainerMon sParty_Jared[] = {
    ...
    .lvl = 37,
    .species = SPECIES_DODUO,
    .moves = {MOVE_SWORDS_DANCE, MOVE_DRILL_PECK, MOVE_ASSURANCE, MOVE_ENDEAVOR},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 37,
    .species = SPECIES_ORICORIO_PAU,
    .moves = {MOVE_PSYCHIC, MOVE_FEATHER_DANCE, MOVE_TEETER_DANCE, MOVE_AIR_SLASH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 37,
    .species = SPECIES_TROPIUS,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_AIR_SLASH, MOVE_CURSE, MOVE_BODY_PRESS, MOVE_LEECH_SEED},
    }
};
...
static const struct TrainerMon sParty_Humberto[] = {
    ...
    .lvl = 39,
    .species = SPECIES_SKARMORY,
    .moves = {MOVE_DRILL_PECK, MOVE_ROOST, MOVE_STEEL_WING, MOVE_TOXIC},
    }
};
...
static const struct TrainerMon sParty_Edwardo[] = {
    ...
    .lvl = 38,
    .species = SPECIES_DODRIO,
    .moves = {MOVE_DRILL_PECK, MOVE_ENDEAVOR, MOVE_DOUBLE_HIT, MOVE_AGILITY},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 38,
    .species = SPECIES_PELIPPER,
    .ability = ABILITY_DRIZZLE,
    .moves = {MOVE_SURF, MOVE_FLY, MOVE_AQUA_RING, MOVE_PROTECT},
    }
};
...
static const struct TrainerMon sParty_Robert1[] = {
    ...
    .moves = {MOVE_FLATTER, MOVE_AIR_SLASH, MOVE_TEETER_DANCE, MOVE_REVELATION_DANCE},
    },
    {
    .lvl = 38,
    .species = SPECIES_NOCTOWL,
    .ability = ABILITY_HONED_MIND,
    .moves = {MOVE_HEX, MOVE_HYPNOSIS, MOVE_EXTRASENSORY, MOVE_REFLECT},
    }
};
...
static const struct TrainerMon sParty_Chester[] = {
    ...
    .lvl = 32,
    .species = SPECIES_TALONFLAME,
    .moves = {MOVE_FLAME_CHARGE, MOVE_ACROBATICS, MOVE_QUICK_GUARD, MOVE_SWORDS_DANCE},
    }
};
...
static const struct TrainerMon sParty_Yasu[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_WHIRLWIND, MOVE_VENOSHOCK, MOVE_LIGHT_SCREEN, MOVE_BUG_BUZZ},
    },
    {
    .lvl = 37,
    .species = SPECIES_TOXICROAK,
    .ability = ABILITY_DRY_SKIN,
    .moves = {MOVE_POISON_JAB, MOVE_SUCKER_PUNCH, MOVE_DRAIN_PUNCH, MOVE_SWAGGER },
    }
};
...
static const struct TrainerMon sParty_Takashi[] = {
    ...
    .moves = {MOVE_POISON_TAIL, MOVE_FURY_CUTTER, MOVE_AERIAL_ACE},
    },
    {
    .lvl = 35,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_SMOKESCREEN, MOVE_SLUDGE_BOMB, MOVE_HEAT_WAVE, MOVE_SELF_DESTRUCT},
    }
};
...
static const struct TrainerMon sParty_Jani[] = {
    ...
    .species = SPECIES_AZUMARILL,
    .ability = ABILITY_HUGE_POWER,
    .moves = {MOVE_CHARM, MOVE_BOUNCE, MOVE_PLAY_ROUGH, MOVE_AQUA_TAIL},
    }
};
...
static const struct TrainerMon sParty_Lao1[] = {
    ...
    .lvl = 23,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_SLUDGE, MOVE_ASSURANCE, MOVE_SMOKESCREEN, MOVE_SELF_DESTRUCT},
    },
    {
    .lvl = 23,
    .species = SPECIES_HOUNDOUR,
    .moves = {MOVE_INCINERATE, MOVE_SMOG, MOVE_BITE, MOVE_ROAR},
    },
    {
    .lvl = 24,
    .species = SPECIES_LOKIX,
    .moves = {MOVE_LOW_KICK, MOVE_DETECT, MOVE_LUNGE, MOVE_LEER},
...
static const struct TrainerMon sParty_Lung[] = {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_FURY_CUTTER, MOVE_METAL_CLAW, MOVE_PROTECT},
    },
    {
    .lvl = 24,
    .species = SPECIES_SHEDINJA,
    .moves = {MOVE_SHADOW_CLAW, MOVE_CONFUSE_RAY, MOVE_PROTECT, MOVE_NONE},
    }
};
...
static const struct TrainerMon sParty_Cyndy1[] = {
    ...
    .lvl = 25,
    .species = SPECIES_PYUKUMUKU,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_COUNTER, MOVE_TAUNT, MOVE_TOXIC},
    }
};
...
static const struct TrainerMon sParty_Cora[] = {
    ...
    .lvl = 32,
    .species = SPECIES_CROAGUNK,
    .moves = {MOVE_POISON_JAB, MOVE_SWAGGER, MOVE_SUCKER_PUNCH, MOVE_ICE_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    .species = SPECIES_HAWLUCHA,
    .moves = {MOVE_FEATHER_DANCE, MOVE_AERIAL_ACE, MOVE_BRICK_BREAK, MOVE_STEEL_WING},
    }
};
...
static const struct TrainerMon sParty_Paula[] = {
    ...
    .heldItem = ITEM_TOXIC_ORB,
    .moves = {MOVE_SPORE, MOVE_DRAIN_PUNCH, MOVE_BULLET_SEED, MOVE_PROTECT},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 32,
    .species = SPECIES_SPINDA,
    .ability = ABILITY_CONTRARY,
    .moves = {MOVE_HYPNOSIS, MOVE_HAMMER_ARM, MOVE_DIZZY_PUNCH, MOVE_BODY_SLAM},
    }
};
...
static const struct TrainerMon sParty_Madeline1[] = {
    ...
    .lvl = 23,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_INCINERATE, MOVE_AMNESIA, MOVE_BULLDOZE, MOVE_SUNNY_DAY},
    },
    {
    .lvl = 24,
    .species = SPECIES_SUNFLORA,
    .moves = {MOVE_ECHOED_VOICE, MOVE_GIGA_DRAIN, MOVE_GROWTH, MOVE_SUNNY_DAY},
...
static const struct TrainerMon sParty_Clarissa[] = {
    ...
    .moves = {MOVE_QUIVER_DANCE, MOVE_PETAL_DANCE, MOVE_MOONBLAST, MOVE_SLEEP_POWDER},
    },
    {
    .lvl = 38,
    .species = SPECIES_POLITOED,
    .ability = ABILITY_DRIZZLE,
    .moves = {MOVE_HYPER_VOICE, MOVE_EARTH_POWER, MOVE_HYPNOSIS, MOVE_HYDRO_PUMP},
    }
};
...
static const struct TrainerMon sParty_Heidi[] = {
    ...
    .lvl = 25,
    .species = SPECIES_HIPPOPOTAS,
    .moves = {MOVE_DIG, MOVE_SAND_ATTACK, MOVE_CRUNCH, MOVE_YAWN},
    },
    {
    .lvl = 25,
    .species = SPECIES_BALTOY,
    .moves = {MOVE_RAPID_SPIN, MOVE_MUD_SLAP, MOVE_PSYBEAM, MOVE_ANCIENT_POWER},
    },
    {
    .lvl = 25,
    .species = SPECIES_LARVITAR,
    .moves = {MOVE_SCREECH, MOVE_STOMPING_TANTRUM, MOVE_ROCK_SLIDE, MOVE_PAYBACK},
    }
};
...
static const struct TrainerMon sParty_Becky[] = {
    ...
    .lvl = 25,
    .species = SPECIES_SANDSHREW,
    .moves = {MOVE_FURY_CUTTER, MOVE_DEFENSE_CURL, MOVE_SLASH, MOVE_DIG},
    .ability = ABILITY_SHARPNESS,
    },
    {
    .lvl = 25,
    .species = SPECIES_POLIWHIRL,
    .moves = {MOVE_ICE_PUNCH, MOVE_BUBBLE_BEAM, MOVE_HYPNOSIS, MOVE_MUD_SHOT},
    }
};
...
static const struct TrainerMon sParty_Martha[] = {
    ...
    .lvl = 27,
    .species = SPECIES_SKITTY,
    .moves = {MOVE_ATTRACT, MOVE_YAWN, MOVE_TICKLE, MOVE_FURY_SWIPES},
    },
    {
    .lvl = 27,
    .species = SPECIES_BEWEAR,
    .moves = {MOVE_BIND, MOVE_BRUTAL_SWING, MOVE_BABY_DOLL_EYES, MOVE_ROCK_SMASH},
    },
    {
    .lvl = 27,
    .species = SPECIES_SWABLU,
    .moves = {MOVE_DRAGON_BREATH, MOVE_ROUND, MOVE_AERIAL_ACE, MOVE_ROOST},
    }
};
...
static const struct TrainerMon sParty_Diana1[] = {
    ...
    .lvl = 26,
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_MACH_PUNCH, MOVE_BULLET_SEED, MOVE_STUN_SPORE, MOVE_HEADBUTT},
    },
    {
    .lvl = 25,
    .species = SPECIES_GLOOM,
    ...
    .lvl = 25,
    .species = SPECIES_FLETCHINDER,
    .moves = {MOVE_FLAME_CHARGE, MOVE_ACROBATICS, MOVE_GROWL, MOVE_NONE},
    }
};
...
static const struct TrainerMon sParty_Irene[] = {
    ...
    .lvl = 23,
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_MACH_PUNCH, MOVE_LEECH_SEED, MOVE_HEADBUTT, MOVE_MEGA_DRAIN },
    },
    {
    .lvl = 23,
    .species = SPECIES_AZUMARILL,
...
static const struct TrainerMon sParty_MiuAndYuki[] = {
    ...
    .lvl = 33,
    .species = SPECIES_BEAUTIFLY,
    .moves = {MOVE_ATTRACT, MOVE_WHIRLWIND, MOVE_BUG_BUZZ, MOVE_AIR_CUTTER},
    },
    {
    .lvl = 33,
    .species = SPECIES_DUSTOX,
    .moves = {MOVE_TOXIC, MOVE_WHIRLWIND, MOVE_BUG_BUZZ, MOVE_VENOSHOCK},
    },
    {
    .lvl = 33,
    .species = SPECIES_VOLBEAT,
    .moves = {MOVE_TAIL_GLOW, MOVE_CHARGE_BEAM, MOVE_THUNDER_WAVE, MOVE_CONFUSE_RAY},
    }, 
    {
    .lvl = 33,
    .species = SPECIES_ILLUMISE,
    .moves = {MOVE_HELPING_HAND, MOVE_ENCORE, MOVE_DRAINING_KISS, MOVE_FOLLOW_ME},
    }, 
};
...
static const struct TrainerMon sParty_Huey[] = {
    ...
    .moves = {MOVE_ROCK_SMASH, MOVE_DETECT, MOVE_LEER, MOVE_PAYBACK},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 15,
...
static const struct TrainerMon sParty_Duncan[] = {
    ...
    .lvl = 31,
    .species = SPECIES_POLIWRATH,
    .moves = {MOVE_BODY_SLAM, MOVE_HYPNOSIS, MOVE_CIRCLE_THROW, MOVE_WATERFALL},
    },
    {
    .lvl = 32,
    .species = SPECIES_MACHOKE,
...
static const struct TrainerMon sParty_Eli[] = {
    ...
    .lvl = 27,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_LAVA_PLUME, MOVE_EARTH_POWER, MOVE_TRAILBLAZE, MOVE_SUNNY_DAY},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 27,
    .species = SPECIES_SCOVILLAIN,
    .moves = {MOVE_FLAMETHROWER, MOVE_HEADBUTT, MOVE_BULLET_SEED, MOVE_GROWTH},
    }
};
...
static const struct TrainerMon sParty_Jazmyn[] = {
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_SWORDS_DANCE, MOVE_PSYCHO_CUT, MOVE_FOCUS_ENERGY},
    }
};
...
static const struct TrainerMon sParty_Hector[] = {
    ...
    .lvl = 26,
    .species = SPECIES_ZANGOOSE,
    .moves = {MOVE_SLASH, MOVE_SWORDS_DANCE, MOVE_DOUBLE_KICK, MOVE_NIGHT_SLASH},
    },
    {
    .lvl = 26,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_POISON_FANG, MOVE_VENOSHOCK, MOVE_ICE_FANG, MOVE_BITE},
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Mudkip[] = {
    ...
    .species = SPECIES_SNORUNT,
    .gender = TRAINER_MON_MALE,
    .moves = {MOVE_HEADBUTT, MOVE_ICE_SHARD, MOVE_PROTECT, MOVE_LEER},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 23,
    .species = SPECIES_GROVYLE,
    .moves = {MOVE_FURY_CUTTER, MOVE_NIGHT_SLASH, MOVE_NEEDLE_ARM, MOVE_DETECT},
    },
};
...
static const struct TrainerMon sParty_BrendanRoute119Mudkip[] = {
    ...
    .moves = {MOVE_SURF, MOVE_PHANTOM_FORCE, MOVE_SCARY_FACE, MOVE_HEADBUTT},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 38,
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_WILL_O_WISP, MOVE_HEX, MOVE_CURSE},
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 39,
    ...
    .moves ={MOVE_ROCK_SLIDE, MOVE_WEATHER_BALL, MOVE_ICE_SHARD, MOVE_STEALTH_ROCK},
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 39,
    .species = SPECIES_SWELLOW,
    .moves ={MOVE_FLY, MOVE_AIR_SLASH, MOVE_FACADE, MOVE_U_TURN},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 40,
    .species = SPECIES_SCEPTILE,
    .moves = {MOVE_LEAF_BLADE, MOVE_X_SCISSOR, MOVE_NIGHT_SLASH, MOVE_DOUBLE_TEAM},
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Treecko[] = {
    ...
    .moves = {MOVE_DOUBLE_KICK, MOVE_AERIAL_ACE, MOVE_FLAME_CHARGE,MOVE_DETECT},
    }
};
...
static const struct TrainerMon sParty_BrendanRoute119Treecko[] = {
    ...
    .moves ={MOVE_VICTORY_DANCE, MOVE_LEAF_BLADE, MOVE_BRICK_BREAK, MOVE_SLEEP_POWDER},
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 39,
    ...
    .moves = {MOVE_BLAZE_KICK, MOVE_BOUNCE, MOVE_SKY_UPPERCUT, MOVE_SLASH},
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Torchic[] = {
    ...
    .moves = {MOVE_MUD_SHOT, MOVE_WATER_PULSE, MOVE_PROTECT, MOVE_ROCK_SMASH},
    }
};
...
static const struct TrainerMon sParty_BrendanRoute119Torchic[] = {
    ...
    .moves = {MOVE_MUDDY_WATER, MOVE_HAMMER_ARM, MOVE_PROTECT, MOVE_EARTH_POWER},
    }
};
...
static const struct TrainerMon sParty_MayRoute119Mudkip[] = {
    ...
    .ability = ABILITY_SWIFT_SWIM,
    .moves = {MOVE_SURF, MOVE_SHADOW_BALL, MOVE_SCARY_FACE, MOVE_CHILLING_WATER},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 38,
    ...
    .moves = {MOVE_LAVA_PLUME, MOVE_ANCIENT_POWER, MOVE_YAWN, MOVE_CURSE},
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 39,
    ...
    .ability = ABILITY_REFRIGERATE,
    .heldItem = ITEM_FOCUS_BAND,
    .moves ={MOVE_HEX, MOVE_WILL_O_WISP, MOVE_DESTINY_BOND, MOVE_FROST_BREATH},
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 39,
...
static const struct TrainerMon sParty_MayRoute119Treecko[] = {
    ...
    .moves ={MOVE_QUIVER_DANCE, MOVE_PETAL_DANCE, MOVE_LEECH_SEED, MOVE_STUN_SPORE},
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 39,
...
static const struct TrainerMon sParty_Davis[] = {
    ...
    .moves = {MOVE_X_SCISSOR, MOVE_STORM_THROW},
    },
    {
    .lvl = 33,
    .species = SPECIES_SCYTHER,
    .moves = {MOVE_X_SCISSOR, MOVE_WING_ATTACK},
    }
};
...
static const struct TrainerMon sParty_Jackson1[] = {
    ...
    .species = SPECIES_BRELOOM,
    .ability = ABILITY_POISON_HEAL,
    .moves = {MOVE_SPORE, MOVE_MACH_PUNCH, MOVE_LEECH_SEED, MOVE_TRAILBLAZE},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 35,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_TAIL, MOVE_RECYCLE, MOVE_APPLE_ACID, MOVE_LEECH_SEED},
    }
};
...
static const struct TrainerMon sParty_Catherine1[] = {
    ...
    .moves = {MOVE_PETAL_BLIZZARD, MOVE_MOONBLAST, MOVE_TOXIC, MOVE_SLUDGE_BOMB},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 35,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_GRAV_APPLE, MOVE_DRAGON_PULSE, MOVE_DRAGON_DANCE, MOVE_ACROBATICS},
    }
};
...
static const struct TrainerMon sParty_GruntMtChimney2[] = {
    ...
    .lvl = 25,
    .species = SPECIES_ZUBAT,
    .moves = {MOVE_AIR_CUTTER, MOVE_POISON_FANG, MOVE_MEAN_LOOK, MOVE_TOXIC},
    },
    {
    .lvl = 25,
    .species = SPECIES_RHYHORN,
    .moves = {MOVE_SMACK_DOWN, MOVE_BULLDOZE, MOVE_STOMP, MOVE_TAIL_WHIP},
    }
};
...
static const struct TrainerMon sParty_GruntWeatherInst5[] = {
    ...
    .species = SPECIES_CORPHISH,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_KNOCK_OFF, MOVE_RAZOR_SHELL, MOVE_PROTECT, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMon sParty_TabithaMtChimney[] = {
    ...
    .lvl = 24,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_SWAGGER, MOVE_ICE_FANG, MOVE_FIRE_FANG, MOVE_ASSURANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 26,
    ...
    .lvl = 26,
    .species = SPECIES_GOLBAT,
    .moves = {MOVE_AIR_CUTTER, MOVE_POISON_FANG, MOVE_MEAN_LOOK, MOVE_U_TURN},
    }
};
...
static const struct TrainerMon sParty_MaxieMtChimney[] = {
    ...
    .lvl = 26,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_CRUNCH, MOVE_SWAGGER},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 26,
    ...
    .ability = ABILITY_SUPER_LUCK,
    .moves = {MOVE_SNARL, MOVE_STEEL_WING, MOVE_AERIAL_ACE, MOVE_NASTY_PLOT},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 28,
    .species = SPECIES_KOFFING,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_SLUDGE, MOVE_FLAMETHROWER, MOVE_PROTECT, MOVE_TOXIC},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 30,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_EARTH_POWER, MOVE_LAVA_PLUME, MOVE_ROCK_SLIDE, MOVE_AMNESIA},
    .ability = ABILITY_SOLID_ROCK,
    .isShiny = TRUE,
    }
};
...
static const struct TrainerMon sParty_Vivi[] = {
    ...
    .lvl = 20,
    .species = SPECIES_LOMBRE,
    .moves = {MOVE_FAKE_OUT, MOVE_KNOCK_OFF, MOVE_MEGA_DRAIN, MOVE_TEETER_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 20,
...
static const struct TrainerMon sParty_Haley2[] = {
    ...
    .lvl = 33,
    .species = SPECIES_LOMBRE,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_FAKE_OUT},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 33,
    .species = SPECIES_NUZLEAF,
    .moves = {MOVE_RAZOR_LEAF, MOVE_LEECH_SEED, MOVE_PAYBACK, MOVE_FAKE_OUT},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 33,
    .species = SPECIES_BRELOOM,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_MACH_PUNCH, MOVE_SPORE, MOVE_SEED_BOMB, MOVE_COUNTER},
    }
};
...
static const struct TrainerMon sParty_Haley3[] = {
    ...
    .moves = {MOVE_SURF, MOVE_RAIN_DANCE, MOVE_GIGA_DRAIN, MOVE_FAKE_OUT},
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 38,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_LEAF_BLADE, MOVE_TAILWIND, MOVE_SUCKER_PUNCH, MOVE_FAKE_OUT},
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 38,
...
static const struct TrainerMon sParty_Haley4[] = {
    ...
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_RAIN_DANCE, MOVE_AIR_SLASH, MOVE_WEATHER_BALL, MOVE_ICY_WIND},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 45,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_RAIN_DISH,
    .moves = {MOVE_SURF, MOVE_LEECH_SEED, MOVE_ENERGY_BALL, MOVE_FAKE_OUT},
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 45,
...
static const struct TrainerMon sParty_Haley5[] = {
    ...
    .ability = ABILITY_RAIN_DISH,
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_RAIN_DANCE, MOVE_HURRICANE, MOVE_WEATHER_BALL, MOVE_ICY_WIND},
    },
    {
    .iv = TRAINER_PARTY_IVS(4, 4, 4, 4, 4, 4),
    .lvl = 52,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_RAIN_DISH,
    .moves = {MOVE_SURF, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_FAKE_OUT},
    },
    {
    .iv = TRAINER_PARTY_IVS(4, 4, 4, 4, 4, 4),
    .lvl = 52,
...
static const struct TrainerMon sParty_Eustace[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 16,
    .species = SPECIES_WINGULL,
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_RAIN_DANCE, MOVE_WING_ATTACK, MOVE_WATER_GUN, MOVE_AQUA_RING},
    .ability = ABILITY_RAIN_DISH,
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 16,
    .species = SPECIES_CROAGUNK,
    .moves = {MOVE_LOW_KICK, MOVE_TOXIC, MOVE_FLATTER, MOVE_POISON_STING},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 16,
    .species = SPECIES_LOMBRE,
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_RAIN_DANCE, MOVE_MEGA_DRAIN, MOVE_FAKE_OUT, MOVE_KNOCK_OFF},
    .ability = ABILITY_SWIFT_SWIM,
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 16,
    .species = SPECIES_CLAUNCHER,
    .moves = {MOVE_WATER_GUN, MOVE_MUD_SLAP, MOVE_AQUA_JET, MOVE_VISE_GRIP},
    }
};
...
static const struct TrainerMon sParty_Doug[] = {
    ...
    .moves = {MOVE_DRAINING_KISS, MOVE_STUN_SPORE, MOVE_POLLEN_PUFF, MOVE_PROTECT},
    },
    {
    .lvl = 33,
    .species = SPECIES_VIKAVOLT,
    .moves = {MOVE_THUNDERBOLT, MOVE_FLASH, MOVE_HYPER_BEAM, MOVE_PROTECT},
    }
};
...
static const struct TrainerMon sParty_Greg[] = {
    ...
    .species = SPECIES_LEDIAN,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_BULLET_PUNCH, MOVE_BULLET_PUNCH, MOVE_U_TURN, MOVE_REFLECT},
    },
    {
    .lvl = 33,
    .species = SPECIES_LOKIX,
    .ability = ABILITY_TINTED_LENS,
    .moves = {MOVE_U_TURN, MOVE_DOUBLE_KICK, MOVE_KNOCK_OFF, MOVE_TRAILBLAZE},
    }
};
...
static const struct TrainerMon sParty_Kent[] = {
    ...
    .lvl = 33,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_METAL_CLAW, MOVE_X_SCISSOR,MOVE_NIGHT_SLASH, MOVE_SWORDS_DANCE},
    },
    {
    .lvl = 33,
    .species = SPECIES_SHEDINJA,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_DIG, MOVE_PROTECT},
    }
};
...
static const struct TrainerMon sParty_James2[] = {
    ...
    .species = SPECIES_SCOLIPEDE,
    .ability = ABILITY_SPEED_BOOST,
    .moves = {MOVE_POISON_TAIL, MOVE_BUG_BITE, MOVE_BULLDOZE, MOVE_SWORDS_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 34,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_LEECH_LIFE, MOVE_AERIAL_ACE, MOVE_SCREECH},
    }
};
...
static const struct TrainerMon sParty_James4[] = {
    ...
    .species = SPECIES_DUSTOX,
    .ability = ABILITY_TOXIC_DEBRIS,
    .moves = {MOVE_TOXIC, MOVE_PROTECT, MOVE_PSYCHIC, MOVE_VENOSHOCK},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 43,
    .species = SPECIES_SCOLIPEDE,
    .ability = ABILITY_SPEED_BOOST,
    .moves = {MOVE_POISON_TAIL, MOVE_X_SCISSOR, MOVE_BULLDOZE, MOVE_SWORDS_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 43,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_X_SCISSOR, MOVE_AERIAL_ACE, MOVE_SCREECH, MOVE_U_TURN},
    }
};
...
static const struct TrainerMon sParty_James5[] = {
    ...
    .species = SPECIES_SCOLIPEDE,
    .ability = ABILITY_SPEED_BOOST,
    .moves = {MOVE_POISON_TAIL, MOVE_X_SCISSOR, MOVE_BATON_PASS, MOVE_SWORDS_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 49,
...
static const struct TrainerMon sParty_Lucas1[] = {
    ...
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_ROCK_TOMB, MOVE_GROWL, MOVE_HEADBUTT},
    .ability = ABILITY_LIGHTNING_ROD,
    },
    {
    .lvl = 24,
    .species = SPECIES_PHANPY,
    .moves = {MOVE_BULLDOZE, MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_ENDURE},
    },
    {
    .lvl = 24,
    .species = SPECIES_TYROGUE,
    .moves = {MOVE_FAKE_OUT, MOVE_MACH_PUNCH, MOVE_HELPING_HAND, MOVE_ROCK_SMASH},
    .heldItem = ITEM_FOCUS_BAND,
    }
};
...
static const struct TrainerMon sParty_Alan[] = {
    ...
    .lvl = 27,
    .species = SPECIES_RHYHORN,
    .moves = {MOVE_STOMP, MOVE_SCARY_FACE, MOVE_BULLDOZE, MOVE_SMACK_DOWN},
    },
    {
    .lvl = 27,
    .species = SPECIES_PROBOPASS,
    .moves = {MOVE_POWER_GEM, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_BODY_PRESS},
    },
...
static const struct TrainerMon sParty_KiraAndDan1[] = {
    ...
    .lvl = 31,
    .species = SPECIES_VOLBEAT,
    .moves = {MOVE_CHARGE_BEAM, MOVE_TAIL_GLOW, MOVE_CONFUSE_RAY, MOVE_THUNDER_WAVE},
    },
    {
    .lvl = 31,
    .species = SPECIES_ILLUMISE,
    .moves = {MOVE_ENCORE, MOVE_STRUGGLE_BUG, MOVE_DRAINING_KISS, MOVE_FLATTER},
    }
};
...
static const struct TrainerMon sParty_Johanna[] = {
    ...
    .lvl = 15,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_POISON_STING, MOVE_MAGICAL_LEAF, MOVE_LEECH_SEED, MOVE_NONE},
    },
    {
    .lvl = 15,
    .species = SPECIES_BEAUTIFLY,
    .moves = {MOVE_GUST, MOVE_MEGA_DRAIN, MOVE_STUN_SPORE, MOVE_BUG_BITE},
    }
};
...
static const struct TrainerMon sParty_Gerald[] = {
    ...
    .lvl = 29,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_FLAMETHROWER, MOVE_ROCK_SLIDE, MOVE_SHADOW_SNEAK, MOVE_ICE_PUNCH},
...
static const struct TrainerMon sParty_Vivian[] = {
    ...
    .lvl = 22,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_FORCE_PALM, MOVE_DETECT, MOVE_CONFUSION, MOVE_THUNDER_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 22,
...
static const struct TrainerMon sParty_Danielle[] = {
    ...
    .lvl = 28,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_DETECT, MOVE_ZEN_HEADBUTT, MOVE_FIRE_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 28,
    .species = SPECIES_MAKUHITA,
    .moves = {MOVE_DETECT,MOVE_THUNDER_PUNCH,MOVE_FIRE_PUNCH, MOVE_BELLY_DRUM},
    }
};
...
static const struct TrainerMon sParty_Hideo[] = {
    ...
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_POISON_FANG, MOVE_GLARE, MOVE_ICE_FANG, MOVE_JAW_LOCK},
    },
    {
    .lvl = 37,
    .species = SPECIES_SKORUPI,
    .moves = {MOVE_NIGHT_SLASH, MOVE_CROSS_POISON, MOVE_KNOCK_OFF, MOVE_BUG_BITE},
    }
};
...
static const struct TrainerMon sParty_Flint[] = {
    ...
    .lvl = 38,
    .species = SPECIES_SWELLOW,
    .moves = {MOVE_BRAVE_BIRD, MOVE_PLUCK, MOVE_DOUBLE_TEAM, MOVE_QUICK_ATTACK},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 38,
    .species = SPECIES_XATU,
    .moves = {MOVE_AIR_SLASH, MOVE_PSYCHIC, MOVE_CONFUSE_RAY, MOVE_PSYCHO_SHIFT},
    }
};
...
static const struct TrainerMon sParty_Ashley[] = {
    ...
    .lvl = 37,
    .species = SPECIES_SWABLU,
    .moves = {MOVE_SING, MOVE_COTTON_GUARD, MOVE_DISARMING_VOICE, MOVE_FEATHER_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 37,
    .species = SPECIES_NATU,
    .moves = {MOVE_POWER_SWAP, MOVE_GUARD_SWAP, MOVE_PSYCHIC, MOVE_ROOST},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 37,
    ...
    .moves = {MOVE_MOONBLAST, MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_HEX},
    }
};
...
static const struct TrainerMon sParty_WallyMauville[] = {
    ...
    .lvl = 23,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_LEECH_SEED, MOVE_TOXIC_SPIKES, MOVE_SLUDGE, MOVE_MEGA_DRAIN},
    },
    {
    .iv = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 23,
    .species = SPECIES_FLETCHINDER,
    .moves = {MOVE_ACROBATICS, MOVE_FLAME_CHARGE, MOVE_QUICK_ATTACK, MOVE_TRAILBLAZE},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 24,
    .species = SPECIES_AZUMARILL,
    .ability = ABILITY_HUGE_POWER,
    .moves = {MOVE_AQUA_TAIL, MOVE_TRAILBLAZE, MOVE_PROTECT, MOVE_BOUNCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 24,
    .species = SPECIES_KIRLIA,
    .gender = TRAINER_MON_MALE,
    .moves = {MOVE_FLASH, MOVE_PSYBEAM, MOVE_DRAINING_KISS, MOVE_CALM_MIND},
    }
};
...
static const struct TrainerMon sParty_WallyPetalburg[] = {
    ...
    .lvl = 33,
    .species = SPECIES_ROSERADE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_TOXIC_SPIKES, MOVE_GIGA_DRAIN, MOVE_TOXIC},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 33,
    .species = SPECIES_FLETCHINDER,
    .moves = {MOVE_ACROBATICS, MOVE_TRAILBLAZE, MOVE_FLAME_CHARGE, MOVE_QUICK_ATTACK},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 33,
    .species = SPECIES_AZUMARILL,
    .ability = ABILITY_HUGE_POWER,
    .moves = {MOVE_AQUA_TAIL, MOVE_PLAY_ROUGH, MOVE_TRAILBLAZE, MOVE_BOUNCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 33,
    ...
    .moves = {MOVE_CRUNCH, MOVE_BULLDOZE, MOVE_STEALTH_ROCK, MOVE_ROCK_SLIDE},
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 33,
    .species = SPECIES_GALLADE,
    .ability = ABILITY_SHARPNESS,
    .moves = {MOVE_BULK_UP, MOVE_PSYCHO_CUT, MOVE_AERIAL_ACE, MOVE_LEAF_BLADE},
    }
};

static const struct TrainerMon sParty_WallyRoute104[] = {
    {
    .lvl = 16,
    .species = SPECIES_MARILL,
    .ability = ABILITY_HUGE_POWER,
...
static const struct TrainerMon sParty_ToriAndTia[] = {
    ...
    .lvl = 24,
    .species = SPECIES_SPINDA,
    .moves = {MOVE_TEETER_DANCE, MOVE_BODY_SLAM, MOVE_COPYCAT},
    },
    {
    .lvl = 24,
    .species = SPECIES_SPINDA,
...
static const struct TrainerMon sParty_TyraAndIvy[] = {
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_STUN_SPORE, MOVE_CHARM, MOVE_FAIRY_WIND},
    .ability = ABILITY_PRANKSTER,
    },
    {
    .lvl = 24,
    .species = SPECIES_GRAVELER,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROCK_POLISH, MOVE_BULLDOZE, MOVE_ROLLOUT},
    }
};
...
static const struct TrainerMon sParty_MelAndPaul[] = {
    ...
    .lvl = 30,
    .species = SPECIES_DUSTOX,
    .moves = {MOVE_LEECH_LIFE, MOVE_MOONLIGHT, MOVE_TOXIC, MOVE_PROTECT},
    },
    {
    .lvl = 30,
    .species = SPECIES_BEAUTIFLY,
    .moves = {MOVE_AIR_CUTTER, MOVE_GIGA_DRAIN, MOVE_ATTRACT, MOVE_STUN_SPORE},
    },
    {
    .lvl = 30,
...
static const struct TrainerMon sParty_Chris[] = {
    ...
    .lvl = 33,
    .species = SPECIES_BASCULEGION_MALE,
    .moves = {MOVE_CRUNCH, MOVE_AQUA_JET, MOVE_LAST_RESPECTS, MOVE_HEADBUTT},
    },
    {
    .lvl = 37,
    .species = SPECIES_FEEBAS,
    ...
    .moves = {MOVE_BARB_BARRAGE, MOVE_FELL_STINGER, MOVE_BITE, MOVE_BRINE},
    }
};
...
static const struct TrainerMon sParty_Sophie[] = {
    ...
    .lvl = 23,
    .species = SPECIES_AZUMARILL,
    .moves = {MOVE_HELPING_HAND, MOVE_AQUA_TAIL, MOVE_BOUNCE, MOVE_TRAILBLAZE},
    .ability = ABILITY_HUGE_POWER,
    },
    {
    .lvl = 24,
    .species = SPECIES_ARAQUANID,
    .moves = {MOVE_HEADBUTT, MOVE_BUG_BITE, MOVE_BUBBLE_BEAM, MOVE_AQUA_RING},
    },
    {
    .lvl = 23,
    .species = SPECIES_LOMBRE,
...
static const struct TrainerMon sParty_Coby[] = {
    ...
    .lvl = 23,
    .species = SPECIES_SKARMORY,
    .moves = {MOVE_CUT, MOVE_BODY_PRESS, MOVE_STEALTH_ROCK, MOVE_PROTECT},
    },
    {
    .lvl = 24,
    .species = SPECIES_TRUMBEAK,
    .moves = {MOVE_FURY_ATTACK, MOVE_ROCK_BLAST, MOVE_PLUCK, MOVE_ROOST},
    .ability= ABILITY_SKILL_LINK,
    },
    {
    .lvl = 23,
    .species = SPECIES_SWELLOW,
    .moves = {MOVE_U_TURN, MOVE_AERIAL_ACE, MOVE_DOUBLE_TEAM, MOVE_ROOST},
    .ability = ABILITY_GUTS,
    }
};
...
static const struct TrainerMon sParty_Angelina[] = {
    ...
    .lvl = 25,
    .species = SPECIES_LILLIGANT,
    .moves = {MOVE_QUIVER_DANCE, MOVE_GIGA_DRAIN, MOVE_STUN_SPORE, MOVE_TEETER_DANCE},
    }
};
...
static const struct TrainerMon sParty_Charlotte[] = {
    ...
    .lvl = 23,
    .species = SPECIES_NUZLEAF,
    .moves = {MOVE_RAZOR_LEAF, MOVE_PAYBACK, MOVE_FAKE_OUT, MOVE_TORMENT},
    },
    {
    .lvl = 23,
    .species = SPECIES_TEDDIURSA,
...
static const struct TrainerMon sParty_Andres1[] = {
    ...
    .lvl = 30,
    .species = SPECIES_PROBOPASS,
    .moves = {MOVE_THUNDER_WAVE, MOVE_FLASH_CANNON, MOVE_POWER_GEM, MOVE_GRAVITY},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 30,
...
static const struct TrainerMon sParty_Josue[] = {
    ...
    .lvl = 30,
    .species = SPECIES_TOUCANNON,
    .moves = {MOVE_BEAK_BLAST, MOVE_BULLET_SEED, MOVE_ROCK_BLAST, MOVE_FURY_ATTACK},
    .ability = ABILITY_SKILL_LINK,
    }
};
...
static const struct TrainerMon sParty_Cory1[] = {
    ...
    .lvl = 29,
    .species = SPECIES_KILOWATTREL,
    .moves = {MOVE_ELECTRO_BALL, MOVE_ROOST, MOVE_PLUCK, MOVE_FEATHER_DANCE},
    },
    {
    .lvl = 29,
    .species = SPECIES_MACHOKE,
...
static const struct TrainerMon sParty_Carolina[] = {
    ...
    .lvl = 29,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_HOWL, MOVE_FIRE_FANG, MOVE_THUNDERBOLT, MOVE_SNARL},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 29,
    .species = SPECIES_HOUNDOOM,
    .moves = {MOVE_THUNDER_FANG, MOVE_BEAT_UP, MOVE_FLAMETHROWER, MOVE_HOWL},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 30,
    .species = SPECIES_ZANGOOSE,
    .moves = {MOVE_NIGHT_SLASH, MOVE_CRUSH_CLAW, MOVE_SWORDS_DANCE, MOVE_DOUBLE_KICK},
    }
};
...
static const struct TrainerMon sParty_Celia[] = {
    ...
    .lvl = 25,
    .species = SPECIES_FARFETCHD_GALARIAN,
    .moves = {MOVE_BRUTAL_SWING, MOVE_DETECT, MOVE_ROCK_SMASH, MOVE_FURY_CUTTER},
    },
    {
    .lvl = 26,
    .species = SPECIES_AZUMARILL,
    .moves = {MOVE_PLAY_ROUGH, MOVE_AQUA_TAIL, MOVE_BOUNCE, MOVE_HELPING_HAND},
    .ability = ABILITY_HUGE_POWER,
    },
    {
    .lvl = 25,
    .species = SPECIES_MASQUERAIN,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_AIR_CUTTER, MOVE_SCARY_FACE, MOVE_STRUGGLE_BUG},
    }
};
...
static const struct TrainerMon sParty_Bryan[] = {
    ...
    .lvl = 25,
    .species = SPECIES_BRONZOR,
    .moves = {MOVE_GYRO_BALL, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY, MOVE_PSYCHIC},
    },
    {
    .lvl = 25,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_FURY_CUTTER, MOVE_DEFENSE_CURL},
    }
};
...
static const struct TrainerMon sParty_Branden[] = {
    ...
    .lvl = 25,
    .species = SPECIES_SWELLOW,
    .moves = {MOVE_PLUCK, MOVE_QUICK_ATTACK, MOVE_QUICK_GUARD, MOVE_DOUBLE_TEAM},
    },
    {
    .lvl = 25,
    .species = SPECIES_NUZLEAF,
    .moves = {MOVE_FAKE_OUT, MOVE_PAYBACK, MOVE_RAZOR_LEAF, MOVE_TORMENT},
    },
    {
    .lvl = 26,
    .species = SPECIES_ARAQUANID,
    .moves = {MOVE_CRUNCH, MOVE_BUBBLE_BEAM, MOVE_TRAILBLAZE, MOVE_AQUA_RING},
    }
};
...
static const struct TrainerMon sParty_Shayla[] = {
    ...
    .lvl = 23,
    .species = SPECIES_ILLUMISE,
    .moves = {MOVE_DRAINING_KISS, MOVE_STRUGGLE_BUG, MOVE_ATTRACT, MOVE_SWEET_SCENT},
    },
    {
    .lvl = 23,
    .species = SPECIES_GLOOM,
...
static const struct TrainerMon sParty_Kyra[] = {
    ...
    .lvl = 30,
    .species = SPECIES_DODRIO,
    .moves = {MOVE_TRAILBLAZE, MOVE_TRI_ATTACK, MOVE_PLUCK, MOVE_ROOST},
    },
    {
    .lvl = 30,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EXTREME_SPEED, MOVE_BELLY_DRUM, MOVE_THUNDER_WAVE, MOVE_FACADE},
    }
};
...
static const struct TrainerMon sParty_Jaiden[] = {
    ...
    .lvl = 30,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_BUG_BITE, MOVE_AERIAL_ACE, MOVE_SWORDS_DANCE, MOVE_PROTECT},
    },
    {
    .lvl = 30,
    .species = SPECIES_MORGREM,
    .ability = ABILITY_PRANKSTER,
    .moves = {MOVE_REFLECT, MOVE_FAKE_OUT, MOVE_FALSE_SURRENDER, MOVE_DAZZLING_GLEAM},
    },
    {
    .lvl = 30,
    .species = SPECIES_SWALOT,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_AMNESIA, MOVE_WATER_PULSE, MOVE_TOXIC},
    }
};
...
static const struct TrainerMon sParty_Alix[] = {
    ...
    .lvl = 30,
    .species = SPECIES_KADABRA,
    .moves = {MOVE_PSYSHOCK, MOVE_SHADOW_BALL, MOVE_THUNDER_PUNCH, MOVE_CALM_MIND},
    },
    {
    .lvl = 30,
    .species = SPECIES_SLOWKING,
    .moves = {MOVE_SURF, MOVE_FLAMETHROWER, MOVE_PSYCHIC, MOVE_CALM_MIND},
    }
};
...
static const struct TrainerMon sParty_Helene[] = {
    ...
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_TRIPLE_KICK, MOVE_RAPID_SPIN, MOVE_SUCKER_PUNCH, MOVE_WIDE_GUARD},
    },
    {
    .lvl = 30,
    .species = SPECIES_PANGORO,
    .moves = {MOVE_NIGHT_SLASH, MOVE_CIRCLE_THROW, MOVE_BULLET_PUNCH, MOVE_TAUNT},
    }
};
...
static const struct TrainerMon sParty_Marlene[] = {
    ...
    .lvl = 26,
    .species = SPECIES_INKAY,
    .moves = {MOVE_HYPNOSIS, MOVE_PLUCK, MOVE_NIGHT_SLASH, MOVE_PSYBEAM},
    }
};
...
static const struct TrainerMon sParty_Fabian[] = {
    ...
    .lvl = 37,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_ROAR, MOVE_THUNDER_WAVE, MOVE_DISCHARGE, MOVE_SNARL},
    },
    {
    .lvl = 37,
    .species = SPECIES_TOXTRICITY_LOW_KEY,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_DISCHARGE, MOVE_ACID_SPRAY, MOVE_SNARL, MOVE_SHOCK_WAVE},
    }
};
...
static const struct TrainerMon sParty_Dayton[] = {
    ...
    .ability = ABILITY_MAGMA_ARMOR,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_SUNNY_DAY, MOVE_LAVA_PLUME, MOVE_SHELL_SMASH, MOVE_ANCIENT_POWER},
    },
    {
    .lvl = 34,
    .species = SPECIES_MAROWAK_ALOLAN,
    .heldItem = ITEM_THICK_CLUB,
    .moves = {MOVE_WILL_O_WISP, MOVE_SHADOW_BONE, MOVE_RETALIATE, MOVE_FIRE_PUNCH},
    }
};
...
static const struct TrainerMon sParty_Rachel[] = {
    ...
    .lvl = 34,
    .species = SPECIES_SEAKING,
    .moves = {MOVE_WATERFALL, MOVE_AQUA_RING, MOVE_BODY_SLAM, MOVE_ATTRACT},
    }
};
...
static const struct TrainerMon sParty_CourtneyMtChimney[] = {
    ...
    .gender = TRAINER_MON_FEMALE,
    .heldItem = ITEM_HEAT_ROCK,
    .moves = {MOVE_SUNNY_DAY, MOVE_INCINERATE, MOVE_SLUDGE_BOMB, MOVE_NASTY_PLOT},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 24,
    ...
    .moves = {MOVE_GROWTH, MOVE_NEEDLE_ARM, MOVE_SUCKER_PUNCH, MOVE_BULLDOZE},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 26,
    ...
    .gender = TRAINER_MON_FEMALE,
    .heldItem = ITEM_POWER_HERB,
    .moves = {MOVE_SOLAR_BEAM, MOVE_THUNDER_FANG, MOVE_BURNING_JEALOUSY, MOVE_SNARL},
    .ability = ABILITY_UNNERVE,
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
...
static const struct TrainerMon sParty_Angelo[] = {
    ...
    .lvl = 23,
    .species = SPECIES_CHARJABUG,
    .moves = {MOVE_CHARGE, MOVE_FLASH, MOVE_BUG_BITE, MOVE_PROTECT},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 24,
    .species = SPECIES_ILLUMISE,
    .moves = {MOVE_FLASH, MOVE_DRAINING_KISS, MOVE_CHARM, MOVE_STRUGGLE_BUG},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 24,
    .species = SPECIES_VOLBEAT,
    .moves = {MOVE_SHOCK_WAVE, MOVE_STRUGGLE_BUG, MOVE_CONFUSE_RAY, MOVE_THUNDER_WAVE},
    }
...
static const struct TrainerMon sParty_Darius[] = {
    ...
    .species = SPECIES_GLIGAR,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_U_TURN, MOVE_EARTHQUAKE, MOVE_KNOCK_OFF, MOVE_POISON_TAIL},
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 39,
    .species = SPECIES_TOUCANNON,
    .ability = ABILITY_SKILL_LINK,
    .moves = {MOVE_FURY_ATTACK, MOVE_ROCK_BLAST, MOVE_BULLET_SEED, MOVE_DRILL_PECK},
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 39,
    .species = SPECIES_NOCTOWL,
    .ability = ABILITY_HONED_MIND,
    .moves = {MOVE_EXTRASENSORY, MOVE_AIR_SLASH, MOVE_HEX, MOVE_ROOST},
    }
};
...
static const struct TrainerMon sParty_Andres2[] = {
    ...
    .lvl = 37,
    .species = SPECIES_SANDSLASH_ALOLAN,
    .moves = {MOVE_GYRO_BALL,MOVE_NIGHT_SLASH, MOVE_RAPID_SPIN, MOVE_ICE_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 37,
...
static const struct TrainerMon sParty_Lacey[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 23,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_HEAT_ROCK,
    .moves = {MOVE_EMBER, MOVE_RAPID_SPIN, MOVE_PROTECT, MOVE_BODY_PRESS},
    ...
    .species = SPECIES_SUNFLORA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LEECH_SEED, MOVE_MAGICAL_LEAF, MOVE_ECHOED_VOICE, MOVE_GROWTH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 23,
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_HEAT_ROCK,
    .moves = {MOVE_WILL_O_WISP, MOVE_HEX, MOVE_SNARL, MOVE_INCINERATE},
    .ability = ABILITY_DROUGHT,
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 24,
    .species = SPECIES_LILLIGANT_HISUIAN,
    .moves = {MOVE_VICTORY_DANCE, MOVE_TEETER_DANCE, MOVE_RAZOR_LEAF, MOVE_STUN_SPORE},
    }
};
...
static const struct TrainerMon sParty_Grant[] = {
    ...
    .moves = {MOVE_DRAGON_BREATH, MOVE_SAND_TOMB, MOVE_SAND_ATTACK, MOVE_TACKLE},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 26,
    .species = SPECIES_JANGMO_O,
    .moves = {MOVE_DRAGON_TAIL, MOVE_PROTECT, MOVE_HEADBUTT, MOVE_SCARY_FACE},
    },
};
