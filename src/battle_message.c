...
static const u8 sText_ResentmentCurse[] = _("{B_DEF_NAME_WITH_PREFIX}'s resentment CURSES\n the {B_ATK_NAME_WITH_PREFIX}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_RESENTMENTCURSE - BATTLESTRINGS_TABLE_START] = sText_ResentmentCurse,
};
